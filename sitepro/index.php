...
<head>
    ...
    <link rel="stylesheet" href="comment style/style.css">
...
<body>
  <div id="page">  
   <div class="wrap">
     <header id="header" class="row cf" style="border-radius:5px">
      
  
      <h1 style=" margin-left: 60px;">TheDawn</h1>
      <button id="primary-nav-button" type="button">Menu</button>
     
      <nav  id="primary-nav" class="dropdown cf" style="border-radius:5px">
       <ul  class="dropdown menu">

                  <li class='active' style="margin-right:5px"> <a class="btn " href="index.html">Home</a></li>
          <li > <a class="btn btn-primary" href="other/tiding.html">Graphic Era news</a> </li>
          <li><a class="btn btn-info" href="other/addressyouknow.html">changing world</a> </li>
          <li>  <a class="btn btn-danger" href="other/story.html">Back Store </a> 
            <ul class="sub-menu">
          ...
          <li><a class="btn btn-primary" href="#">follow me</a>
           ...
           <li  style="margin-right:5px;width: 3cm;"><img class="img-responsive" src="https://cdn.vectorstock.com/i/thumb-large/82/81/letter-d-logo-icon-design-template-elements-vector-8948281.jpg"></li>
...
<div class="container-fluid" style="background-color:#2196F3;color:#fff;height:180px;border-radius: 10px">
  ...
  <p>"We build our computer (systems) the way we build our cities: over time, without a plan, on top of ruins." - Ellen Ullman</p>
...
<center>save whatever text you feel important here</center>
 <body onload="fetchIssues()" style="width: 500px">
    <div class="container">
   
      <div class="jumbotron">
       <h3>Your Privae Save</h3>
