     ...
     exit;
      ...
      $username = $_SESSION['username'];
       $viewongooglemap="default" ;
   	   $query1="INSERT INTO roominfo(datetime,username,landlord,address,image1,image2,image3,rent,info,levelset,status,city,cat,contact)
   	    VALUES('$datetime','$username','$landlord','$address','$image1','$image2','$image3','$rent','$info','$levelset','on','$city','$Cat1','$contact')";
           ...
           <div class="form-group">
            ...
            <input class="form-control" type="text" name="Contact" id="contact" placeholder="Enter Your Contact Number">
                  ...
                  <div class="form-group">
                   ...
                   <div class="checkbox ">
                      <label><input type="checkbox" name="cat1" value="1">Boys</label>
                    </div>
                    <div class="checkbox ">
                      <label><input type="checkbox" name="cat1" value="2">Girls</label>
                    </div>
                    <div class="checkbox ">
                      <label><input type="checkbox" name="cat1" value="3">Family</label>
                    </div>
                    <div class="checkbox ">
                        <label><input type="checkbox" name="cat1" value="4">Others</label>
                    </div>
                    <br>
                        </div>
