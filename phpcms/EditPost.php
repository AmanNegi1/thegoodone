    ...
    $_SESSION["ErrorMessage"]="To long Name";
     ...
     exit;
	    ...
	    $ConnectingDB=mysqli_select_db($Connection,"phpcms");
	     ...
	     $PostIdFromUrl1=$_GET['Edit'];
   	    $query1="UPDATE adminportal SET datetime='$datetime',title='$title',catagory='$Catagory',author='$Admin',image='$image',post='$post'WHERE id ='$PostIdFromUrl1'";
		...
		<div class="col-sm-10"><!--middle div-->
			...
			<div>
				<?php 
                  $ConnectingDB;
				  $PostIdFromUrl1=$_GET['Edit'];
                $viewquery="SELECT * FROM adminportal WHERE Id='$PostIdFromUrl1' ORDER BY datetime desc";
			...
			<div>
				<form action="EditPost.php?Edit=<?php echo $PostIdFromUrl1; ?>" enctype="multipart/form-data" method="post">
					<fieldset>
					...
					<div class="form-group">
						...
						<label for="catselect">&nbsp;<span style="font-style: bold;color:black;font-size: medium;">Select Catagory:</span></label>
                         <span>existing Categpry is </span>
                ...
                while ($datarows=mysqli_fetch_array($execute)) {
                 ...
                 <?php 
					...
					<div class="form-group">
						...
						<br>
						<input class="btn btn-success" type="submit" name="Submit" value="Update" onclick="warn()">
						<script >
							function warn(){
