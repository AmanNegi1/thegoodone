...
if(isset($_POST['register_button'])){
    ...
    if (strlen($password>40||strlen($password<5))) {
		...
		$check_user_query=mysqli_query($con,"SELECT username from user_register where username='$username'");
		$i=0;
	...
	//	$rand=rand(1,2);
	   ...
	   // else if($rand==2{
		...
		$query="INSERT INTO user_register (firstname,lastname,username,email,password,date,profile) VALUES ('$fname','$lname','$username','$email','$password','$datetime','$profile')";
