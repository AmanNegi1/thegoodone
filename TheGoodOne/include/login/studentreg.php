...
if(isset($_POST['register_button'])){
  ...
  //  $skills=mysqli_real_escape_string($Connection,$_POST['Skills']);
	//$skills=str_replace(' ', '', $skills);//remove spaces..
  ...
  //  $_SESSION['Skills']=$skills;
	...
	//	$rand=rand(1,2);
	   ...
	   // else if($rand==2{
		...
		$query="INSERT INTO studentregister (firstname,lastname,username,collegename,skills,email,password,date,profile,uniqueColId,user_closed) VALUES ('$fname','$lname','$username','$collname','$skills','$email','$password','$datetime','$profile','$uniqueColId','NO')";
